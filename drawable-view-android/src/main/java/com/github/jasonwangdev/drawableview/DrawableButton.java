 ...
 *支援設置顯示圖片大小的 Button
 *
 * 使用 Button 需要搭配圖片並控制圖片大小時，原生的 Button 沒有設置 Drawable 長寬大小相關的屬性，雖然可
...
public class DrawableButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Drawable[] drawables = {typedArray.getDrawable(R.styleable.DrawableButton_drawableLeft),
                                typedArray.getDrawable(R.styleable.DrawableButton_drawableTop),
                                typedArray.getDrawable(R.styleable.DrawableButton_drawableRight),
                                typedArray.getDrawable(R.styleable.DrawableButton_drawableBottom)};

        // 沒有設置圖片時大小預設 0，有設置圖片但沒有設置大小時預設對應解析度的圖片的原始大小
        drawableSize[0][0] = drawables[0] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableLeftWidth, drawables[0].getIntrinsicWidth()) : 0;
        drawableSize[0][1] = drawables[0] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableLeftHeight, drawables[0].getIntrinsicHeight()) : 0;

        drawableSize[1][0] = drawables[1] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableTopWidth, drawables[1].getIntrinsicWidth()) : 0;
        drawableSize[1][1] = drawables[1] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableTopHeight, drawables[1].getIntrinsicHeight()) : 0;

        drawableSize[2][0] = drawables[2] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableRightWidth, drawables[2].getIntrinsicWidth()) : 0;
        drawableSize[2][1] = drawables[2] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableRightHeight, drawables[2].getIntrinsicHeight()) : 0;

        drawableSize[3][0] = drawables[3] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableBottomWidth, drawables[3].getIntrinsicWidth()) : 0;
        drawableSize[3][1] = drawables[3] != null ? typedArray.getDimensionPixelSize(R.styleable.DrawableButton_drawableBottomHeight, drawables[3].getIntrinsicHeight()) : 0;
